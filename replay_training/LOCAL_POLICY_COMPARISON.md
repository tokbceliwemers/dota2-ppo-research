...
It also rejects a mixed or unidentified observation version; this comparison
uses the 25-feature `lane_v3` contract.

## Policies

- Baseline: `checkpoints\lane_expert_bc_v3.pt`
- Candidate: `checkpoints\headless_lane_context_v3.pt` (created from the
...
dota-ppo bridge checkpoints\lane_expert_bc_v3.pt `
  --rollouts data\evaluations\baseline_context_v3_{batch:03d}.npz --device cuda
```
...
```powershell
dota-ppo bridge checkpoints\headless_lane_context_v3.pt `
  --rollouts data\evaluations\candidate_context_v3_{batch:03d}.npz --device cuda
```
...
dota-ppo compare-rollouts `
  data\evaluations\baseline_context_v3_001.npz data\evaluations\baseline_context_v3_002.npz data\evaluations\baseline_context_v3_003.npz `
  --candidate data\evaluations\candidate_context_v3_001.npz data\evaluations\candidate_context_v3_002.npz data\evaluations\candidate_context_v3_003.npz `
  --output reports\lane_context_v3_comparison.json
```
